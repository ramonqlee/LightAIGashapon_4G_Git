...
TIME_SYNC_INTERVAL_SEC = 10--时间同步发起的间隔
...
ENABLE_MERGE_BOARD_ID = true--是否合并所有获得的小板子id
...
KEEP_UART_ALIVE_INTERVAL_MS = 60*1000--uart心跳维持时间
DETECT_UART_ALIVE_INTERVAL_MS = 2*KEEP_UART_ALIVE_INTERVAL_MS--uart无响应的时间
UART_BROKE_COUNT=0
lastKeepAliveTime=nil--上次心跳回复的时间
masterBoardId="UNDEF"
ALL_BOARD_CHECKC_INTERVAL = 5*60*1000
ALL_BOARD_COUNT = -1
BOARD_CHECK_COUNT = 0
MAX_BOARD_CHECK_COUNT = 12
